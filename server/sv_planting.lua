...
RegisterNetEvent('weedplanting:server:GiveWater', function(netId)
    ...
    if exports[Config.Inventory]:RemoveItem(src, Config.WaterItem, 1) then        
...
RegisterNetEvent('weedplanting:server:GiveFertilizer', function(netId)
    ...
    if exports[Config.Inventory]:RemoveItem(src, Config.FertilizerItem, 1) then
...
RegisterNetEvent('weedplanting:server:AddMaleSeed', function(netId)
    ...
    if exports[Config.Inventory]:RemoveItem(src, Config.MaleSeed, 1) then
